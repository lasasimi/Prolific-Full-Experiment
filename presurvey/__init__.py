...
class FailedAttentionCheck(Page):
    ...
    @staticmethod
    def is_displayed(player: Player):
        return player.participant.gives_consent and player.participant.failed_attention_check and not player.participant.training_success or player.participant.vars['training_attempt'] == 0
...
page_sequence = [Introduction, NoConsent, ExitPage, Demographics, Neighborhood, NeighborhoodInstruction, Training, TrainingNeighbor_1, TrainingNeighbor_2, AttentionCheck, TrainingNeighbor_3,  FailedAttentionCheck, Scenario, FinalPage]
