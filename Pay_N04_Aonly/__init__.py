...
class MyPage(Page):
    ...
    def js_vars(player: Player):
        ...
        if not player.participant.eligible_notneutral:
            player.participant.reason="We are looking for participants who have specific opinions about the issue, which is those who want to interview the family first, so you were screened out. You will still receive your base payment. Thanks for your time!"
            return dict(
